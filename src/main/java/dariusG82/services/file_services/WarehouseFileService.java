...
public class WarehouseFileService implements WarehouseInterface, FileReaderInterface {
    ...
    AccountingFileService accountingFileService = new AccountingFileService();
    @Override
    public void receiveGoods(long orderNr) throws OrderDoesNotExistException, IOException, ItemIsNotInWarehouseExeption {
        List<OrderLine> purchaseOrdersLines = accountingFileService.getAllOrderLines(PURCHASE_ORDERS_LINES_PATH);
    ...
    List<Item> getItemsWithUpdatedQuantityList(List<Item> itemsToUpdate) {
    ...
    List<Item> getItemsList(List<Long> itemsIDs) {
